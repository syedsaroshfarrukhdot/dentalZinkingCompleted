    ...
    <>
      <div className="site_wrapper animate__animated  animate__fadeInUp">
        ...
        <div className="btn_container_1_single">
          ...
          >
            <b>></b>
            <span className="glyphicon glyphicon-menu-right"></span>ANGEBOT
            ANFORDERN
          </Button>
        </div>
      </div>
            ...
            <div className="col-xs-12">
              <div className="tooltipp">
                ...
                <div className="tooltipp-text">
                  ...
                  >
                    Anhand Ihrer Angaben <strong>haben</strong> wir nun Ihr{" "}
                    <strong>Sparpotential und die Tarifauswahl</strong> für{" "}
                    <strong>
                      Ihr persönliches und unverbindliches Angebot
                    </strong>{" "}
                    ermittelt.
                  </p>
                </div>
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      <div style={{ marginTop: 30 }}>
        <div>
          <h4 className="h5 aniimation-color-ten">
            {props.label1}
            <br></br>
